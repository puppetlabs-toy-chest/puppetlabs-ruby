          ...
          case $version {
            /^1\.8.*$/:{
              ...
              if ! $suppress_warnings and versioncmp($::lsbdistrelease, '14.04') >= 0 {
                warning('Packages for Ruby 1.8 are not available from default respositories.')
              }
            }
            /^1\.9.*$/:{
            ...
            /^2\.0.*$/:{
              ...
              if ! $suppress_warnings and versioncmp($::lsbdistrelease, '13.10') < 0 {
                warning('Packages for Ruby 2.0 are not available from default respositories.')
              }
            }
            /^2\.1.*$/:{
              $real_ruby_package  = "${ruby::params::ruby_package}2.1"
              if ! $suppress_warnings {
                warning('Packages for Ruby 2.1 are not available from default respositories.')
              }
            }
            default: {
              $real_ruby_package  = $ruby_package
